...
import com.wbtech.common.PostClientData;
...
//			editor.commit();
	...
	public  static void postClientDataProc(Context context){
		if(isFirst){
			 TelephonyManager tm = (TelephonyManager) (context.getSystemService(Context.TELEPHONY_SERVICE)); 
