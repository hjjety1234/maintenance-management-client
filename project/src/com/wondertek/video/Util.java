...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/**
	 * Data Connection 的打开与关闭受手机自身的总开关控制。
	 * 只有在手机自身总开关打开的情况下，应用程序才能自由切换Data Connection状态。否则，没有任何响应。
	 * 
	 * 备注：
	 *     “海卓” 等同系列应用亦如此。
	 *     
	 ...
	 * @return
	 */
//	private static boolean SetDataConnectionEnable(boolean enable)
//	{
...
//        {
//			try {
//				result = mITelephony.enableDataConnectivity();
...
//        {
//        	try {
//        		result = mITelephony.disableDataConnectivity();
//			} catch (RemoteException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
