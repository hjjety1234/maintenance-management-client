//package com.wondertek.video.authentic2;
//
//import tf.shengan.ssl.SSLAutoService;
//
...
//public class Authentic2Observer {		
//		
//	private static Authentic2Observer instance = null;
//	private VenusActivity venusHandle = null;
//	
//	private SSLAutoService autoService = null;
...
//	
//	private Authentic2Observer(VenusActivity va)
//	{
//		venusHandle = va;
//	}
//	
//	public static Authentic2Observer getInstance(VenusActivity va)
//	{
//		if(instance == null)
//		{
//			instance = new Authentic2Observer(va);
//		}
//		
//		return instance;
//	}
...
//				try {
//					autoService = new SSLAutoService(service);
//				} catch (Exception e) {
...
//	SetCheckAppInterval
//	*/
//	void javaSetCheckAppInterval(int nSeconds)
//	{
//		Util.Trace("Authentic java SetCheckAppInterval");
//		try 
//		{
//			autoService.setCheckAppInterval(nSeconds);
//		} 
//		catch (RemoteException e) 
//		{
//			// TODO Auto-generated catch block
...
//	GetAppStatus
//	*/
//	int javaGetAppStatus(String appName)
//	{
//		Util.Trace("Authentic java GetAppStatus appName = " + appName);
//		int rtn = 0;
//		try 
//		{
//			rtn = autoService.getAppStatus(appName);
//		} 
//		catch (RemoteException e) 
//		{
//			// TODO Auto-generated catch block
...
//	SetDisplayToast
//	*/
//	void javaSetDisplayToast(boolean display)
//	{
//		Util.Trace("Authentic java SetDisplayToast");
//		try 
//		{
//			autoService.setDisplayToast(display);
//		} 
//		catch (RemoteException e) 
//		{
//			// TODO Auto-generated catch block
...
//	SetPin
//	*/
//	void javaSetPin(String pin)
//	{
//		Util.Trace("Authentic java SetPin pin = " + pin);
//		try 
//		{
//			autoService.setPin(pin);
//		} 
//		catch (RemoteException e) 
//		{
//			// TODO Auto-generated catch block
...
//	sm1
//	*/
//	String javaSm1(int flag, String strSm1Key, String strInData, int outDataLenth)
//	{
//		Util.Trace("Authentic java sm1 flag = " + flag + " strSm1Key = " + strSm1Key + " strInData = " + strInData + " outDataLenth = " + outDataLenth);
//		byte[] outData = new byte[outDataLenth];
//		Util.Trace( "Authentic java " + outData.length);
//		
//		byte[] pbOutDataLen = autoService.intToBytes(outData.length);
//		byte[] sm1Key = strSm1Key.getBytes();
//		byte[] inData = strInData.getBytes();
//
//		int nRet = autoService.sm1(flag, sm1Key, sm1Key.length, 
//				inData, inData.length, outData, pbOutDataLen);
//		
//		if(nRet == 0)
//			return outData.toString();
//		else
//		{
//			Util.Trace("error: flag =" +flag + ", nRet = " + nRet);
//			return "";
//		}
//	}
//	
