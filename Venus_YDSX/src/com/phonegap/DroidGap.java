...
public class DroidGap extends PhonegapActivity {
    ...
    protected int appView_x =0;
    protected int appView_y =0;
    protected int appView_width =0;
    protected int appView_height =0;
    protected WebViewClient webViewClient;
    private ArrayList<Pattern> whiteList = new ArrayList<Pattern>();
    private HashMap<String, Boolean> whiteListCache = new HashMap<String,Boolean>();

    protected AbsoluteLayout root;
    ...
    private boolean bgobacknow = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //  getWindow().setFlags(WindowManager.LayoutParams.FLAG_FORCE_NOT_FULLSCREEN,
        ...
        root = new AbsoluteLayout(this);
     //   root.setOrientation(LinearLayout.VERTICAL);
        root.setBackgroundColor(this.backgroundColor);
      /*  root.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, 
                ViewGroup.LayoutParams.FILL_PARENT, 0.0F));*/
        if(appView_width==0 ||appView_height==0)
        	root.setLayoutParams(new AbsoluteLayout.LayoutParams(width, height, 0, 0));
        else
        	root.setLayoutParams(new AbsoluteLayout.LayoutParams(appView_width, appView_height, appView_x, appView_y));
    ...
    public void init() {
       ...
       /* this.appView.setLayoutParams(new LinearLayout.LayoutParams(
        ...
        if(appView_width==0 ||appView_height==0)
        {
            ...
            int width = display.getWidth();
            int height = display.getHeight();
        	this.appView.setLayoutParams(new AbsoluteLayout.LayoutParams(width, height, 0, 0));
        }
        else
        	this.appView.setLayoutParams(new AbsoluteLayout.LayoutParams(appView_width, appView_height, appView_x, appView_y));
     ...
     * ���webiew��view��
    */
    public void AddWebView(AbsoluteLayout al)
    {
    	al.addView(root);
    }
    ...
    public void setviewsize(int x,int y,int width,int height)
    {
    	...
    	appView_y = y;
    	appView_width = width;
    	appView_height = height;
    	if(appView!=null&& root!=null)
    	{	
    		this.root.setLayoutParams(new AbsoluteLayout.LayoutParams(width, height, x, y));
    		this.appView.setLayoutParams(new AbsoluteLayout.LayoutParams(width, height, 0, 0));
    	}
    }
    ...
    private void handleActivityParameters() {
        ...
        // If backgroundColor
        this.backgroundColor = this.getIntegerProperty("backgroundColor", Color.TRANSPARENT);
    ...
    private void loadUrlIntoView(final String url) {
        ...
        this.runOnUiThread(new Runnable() {
            public void run() {
                ...
                me.urls.push(url);
                //��������ʱ�ż�¼ǰһ��ҳ�棬�������perurls��¼
                LOG.d(TAG,"bgobacknow =" +bgobacknow);
                if(!bgobacknow)
                	me.perurls.clear();
                bgobacknow = false;
...
*/
        ...
        if (this.urls.size() > 1) {
            this.perurls.push(this.urls.pop());                // Pop current url         
     ...
     * ǰһҳ��
     */
    public boolean perHistory() {
        if (this.perurls.size() > 0) { 
            String url = this.perurls.pop();            
            bgobacknow = true;
            this.loadUrl(url);//���ڸ÷����Ὣurl����urls�У��˲�����Ҫִ��urls.push(rul);
            return true;
        }
        return false;
    }
