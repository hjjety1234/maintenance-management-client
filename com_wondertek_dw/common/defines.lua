...
Alias = {
    ...
    cardispatch = 'MODULE:\\com_wondertek_dw\\m_carDispatch.wdml', -- 车辆申请
    dateDialog = 'MODULE:\\com_wondertek_dw\\dateDialog.wdml', -- 日期选择
    m_yibandetail = 'MODULE:\\com_wondertek_dw\\m_yibandetail.wdml', -- 已办详情
    ...
    m_resourcereport = 'MODULE:\\com_wondertek_dw\\',
