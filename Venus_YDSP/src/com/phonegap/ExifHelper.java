...
public class ExifHelper {
    ...
    public void readExifData() {
        this.aperature = inFile.getAttribute("FNumber");
        this.datetime = inFile.getAttribute(ExifInterface.TAG_DATETIME);
        this.exposureTime = inFile.getAttribute("ExposureTime");
        this.flash = inFile.getAttribute("Flash");
        this.focalLength = inFile.getAttribute("FocalLength");
        this.gpsAltitude = inFile.getAttribute("GPSAltitude");
        this.gpsAltitudeRef = inFile.getAttribute("GPSAltitudeRef");
        this.gpsDateStamp = inFile.getAttribute("GPSDateStamp");
        this.gpsLatitude = inFile.getAttribute(ExifInterface.TAG_GPS_LATITUDE);
        this.gpsLatitudeRef = inFile.getAttribute(ExifInterface.TAG_GPS_LATITUDE_REF);
        this.gpsLongitude = inFile.getAttribute(ExifInterface.TAG_GPS_LONGITUDE);
        this.gpsLongitudeRef = inFile.getAttribute(ExifInterface.TAG_GPS_LONGITUDE_REF);
        this.gpsProcessingMethod = inFile.getAttribute("GPSProcessingMethod");
        this.gpsTimestamp = inFile.getAttribute("GPSTimeStamp");
        this.iso = inFile.getAttribute("ISOSpeedRatings");
        this.make = inFile.getAttribute("Make");
    ...
    public void writeExifData() throws IOException {
        ...
        if (this.aperature != null) {
            this.outFile.setAttribute("FNumber", this.aperature);
        }
