1.此project是所有基于Android.sln.3.2.0(cnlive分支)的项目升级所参考的project。
2.升级步骤
（1）引擎添加好新功能或 bug fix后，会通知项目人员开始Force自构建 Project Report for PJ-3_2_0_640x960 。
（2）项目人员从\\192.168.1.124\publisher\PJ-3_2_0_640x960获取最新project及framework.dat(建议取framework_log.dat,重命名为framework.dat)。
