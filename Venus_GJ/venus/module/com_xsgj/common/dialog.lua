...
Dialog.propTable = {
    ...
    bgImg = {rect='70,220,365,255', src='file://pics/dialog_new.png', style='sudoku-auto', sudoku='4,4,4,4', extendstyle='1111'},
    iconImg = {rect='58,230,48,48', src='', extendstyle='1111'},
    noticeLabel = {rect='128,235,148,48', color='#000000', text='提醒', extendstyle='1111'}, -- 对话框标题
    messageText = {rect='90,300,320,55', ['h-align']='center', color='#000000', -- 对话框内容
    text='textarea 文本描述', frame='true', ['line-height']='28', loop='true', step='1', top='0', extendstyle='1111'},
    okBtn = {rect='120,400,109,40', OnSelect='_dialogClose', text='', 
            normal = 'src:file://pics/ok_d.png;style:sudoku-auto;sudoku:4,4,4,4',
            focus = 'src:file://pics/ok_s.png;style:sudoku-auto;sudoku:4,4,4,4', extendstyle='1111'},
    cancelBtn = {rect='280,400,109,40', OnSelect='_dialogClose', text='', 
            normal = 'src:file://pics/cancel_d.png;style:sudoku-auto;sudoku:4,4,4,4',
            focus = 'src:file://pics/cancel_s.png;style:sudoku-auto;sudoku:4,4,4,4', extendstyle='1111'},
}
...
function Dialog:show(title, message, typeStr, okCallback, cancelCallback)
    ...
    if typeStr == "cancel" or typeStr == "ok" then
        Dialog.propTable.okBtn.rect = "200,400,109,40"
        ...
        Dialog.propTable.okBtn.rect = "120,400,109,40"
        Dialog.propTable.cancelBtn.rect = "280,400,109,40"
		Dialog.propTable.okBtn.visible = 'true'
		Dialog.propTable.okBtn.enable = 'true'
