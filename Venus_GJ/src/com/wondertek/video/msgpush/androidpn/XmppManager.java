...
public class XmppManager {
    ...
    private boolean isRegistered() {
        return (sharedPrefs.contains(Constants.XMPP_USERNAME)
                ...
                && MsgPushManager.getInstance().isUserChanged();
...
//                    getConnection().startKeepAliveThread(xmppManager);
    ...
    private String getNewUserName() {
    	String name = MsgPushManager.getInstance().javaGetUser("username");
    	if (name == null || "".equals(name)) {
    		name = newRandomUUID();
    	}
        Log.i(LOGTAG, "USERNAME:" + name);
    	return name;
    }
    
    private String getNewPassWord() {
    	String word = MsgPushManager.getInstance().javaGetUser("password");
        if (word == null || "".equals(word)) {
        	word = newRandomUUID();
        }
        Log.i(LOGTAG, "PASSWORD:" + word);
        return word;
    }
